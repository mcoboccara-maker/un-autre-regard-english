...
def draw_icon(output_path: str):
    ...
    context.set_source_rgb(0, 0, 0, 0)  # Transparent fill
    ...
    # Eyes
    context.set_source_rgb(0x34 / 255, 0xca / 255, 0xca / 255)
    context.arc(SIZE * 0.38, SIZE * 0.35, SIZE * 0.02, 0, 2 * 3.14159)
    context.fill()
    context.arc(SIZE * 0.62, SIZE * 0.35, SIZE * 0.02, 0, 2 * 3.14159)
    context.fill()

    # Mouth
    context.arc(SIZE * 0.5, SIZE * 0.48, SIZE * 0.18, 20 * (3.14159 / 180), 160 * (3.14159 / 180))
    context.set_line_width(SIZE * 0.03)
    context.stroke()
