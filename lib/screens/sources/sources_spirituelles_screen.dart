...
class _SourcesSpirituellesScreenState extends State<SourcesSpirituellesScreen> {
  ...
  final List<SpiritualSource> _sources = [
    ...
    SpiritualSource(
      ...
      iconPath: 'assets/univers_visuel/theravada.png',
      description: 'Way of the Elders — the oldest Buddhist school, centered on personal discipline, Vipassana meditation and individual liberation.',
      modeOfThought: 'Methodical observation of the mind, mindfulness, gradual progression through personal effort and ethics.',
      worldView: 'The world is impermanent (anicca); suffering arises from attachment. Freedom is won through inner clarity.',
    ),
    SpiritualSource(
      id: 'zen',
      name: 'Zen Buddhism',
      iconPath: 'assets/univers_visuel/zen.png',
      description: 'Direct awakening through immediate experience — zazen (sitting meditation), koans and radical stripping away of all concepts.',
      modeOfThought: 'Beyond words and intellect; direct experience, total presence, letting go of the thinking mind.',
      worldView: 'Awakened nature is already here, right now. Nothing to achieve — just see clearly.',
    ),
    SpiritualSource(
      id: 'advaita_vedanta',
      name: 'Advaita Vedānta',
      iconPath: 'assets/univers_visuel/advaita_vedanta.png',
      description: 'Radical non-duality from Hinduism — the individual Self (Atman) and the Absolute (Brahman) are One. The phenomenal world is illusion (māyā).',
      modeOfThought: 'Self-inquiry through the question "Who am I?", discrimination between the real and the illusory, liberating knowledge.',
      worldView: 'You ARE the Absolute — separation is an illusion. Knowledge of your true nature dissolves all suffering.',
    ),
    SpiritualSource(
      id: 'bhakti',
      name: 'Bhakti (Hindu devotion)',
      iconPath: 'assets/univers_visuel/bhakti.png',
      description: 'Path of devotional love — the personal and ardent relationship with the divine as a path to liberation, accessible to all.',
      modeOfThought: 'The heart before the intellect; loving surrender to the divine, chanting, prayer, total devotion that transcends the ego.',
      worldView: 'God is real and personal. Love is the most powerful force — it transforms all suffering into offering.',
    ),
